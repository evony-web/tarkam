...
export function PlayerCard({
  ...
  const cardContent = (
    <>
      ...
      <AvatarMedia src={avatarSrc} alt={gamertag} fill sizes="(max-width: 768px) 50vw, (max-width: 1024px) 33vw, 250px" className="absolute inset-0 object-cover transition-transform duration-500 hover:scale-105" objectPosition="center 20%" loading="lazy" />
